...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_MMA8451_InitPins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void BOARD_MMA8451_InitPins(void)
{
    ...
    GPIO_PinInit(BOARD_MMA8451_INITPINS_ACCEL_IRQ_8_GPIO, BOARD_MMA8451_INITPINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8_config);
    ...
    PORT_SetPinConfig(BOARD_MMA8451_INITPINS_ACCEL_IRQ_8_PORT, BOARD_MMA8451_INITPINS_ACCEL_IRQ_8_PIN, &ACCEL_IRQ_8);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
